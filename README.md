...
# Encontrar o campo de usuário e digitar o usuário
...
# Clicar no Painel SSW
painel_ssw = browser.find_element(By.XPATH, "//*[@title='Painéis SSW']")
painel_ssw.click()
time.sleep(4)

# Clicar no SLA Gestão Cliente
painel_sla = browser.find_element(By.XPATH, "//*[@title='SLA - Gestão cliente']")
painel_sla.click()
time.sleep(9)

# Encontre o elemento da imagem usando um seletor (por exemplo, seletor CSS ou XPath)
...
# Obtenha o atributo 'src' da imagem
...
# Use bibliotecas como requests ou urllib para baixar a imagem
